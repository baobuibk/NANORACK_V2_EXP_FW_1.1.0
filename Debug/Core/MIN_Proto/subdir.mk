...
C_SRCS += \
../Core/MIN_Proto/min_process.c 

OBJS += \
./Core/MIN_Proto/min_process.o 

C_DEPS += \
./Core/MIN_Proto/min_process.d 


# Each subdirectory must supply rules for building sources it contributes
Core/MIN_Proto/%.o Core/MIN_Proto/%.su Core/MIN_Proto/%.cyclo: ../Core/MIN_Proto/%.c Core/MIN_Proto/subdir.mk
...
clean: clean-Core-2f-MIN_Proto

clean-Core-2f-MIN_Proto:
	-$(RM) ./Core/MIN_Proto/min_process.cyclo ./Core/MIN_Proto/min_process.d ./Core/MIN_Proto/min_process.o ./Core/MIN_Proto/min_process.su

.PHONY: clean-Core-2f-MIN_Proto
