...
C_SRCS += \
../Core/MIN_Proto/min/min.c 

OBJS += \
./Core/MIN_Proto/min/min.o 

C_DEPS += \
./Core/MIN_Proto/min/min.d 


# Each subdirectory must supply rules for building sources it contributes
Core/MIN_Proto/min/%.o Core/MIN_Proto/min/%.su Core/MIN_Proto/min/%.cyclo: ../Core/MIN_Proto/min/%.c Core/MIN_Proto/min/subdir.mk
...
clean: clean-Core-2f-MIN_Proto-2f-min

clean-Core-2f-MIN_Proto-2f-min:
	-$(RM) ./Core/MIN_Proto/min/min.cyclo ./Core/MIN_Proto/min/min.d ./Core/MIN_Proto/min/min.o ./Core/MIN_Proto/min/min.su

.PHONY: clean-Core-2f-MIN_Proto-2f-min
