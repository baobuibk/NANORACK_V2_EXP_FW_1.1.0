...
C_SRCS += \
../BSP/RingBuffer/ring_buffer.c 

OBJS += \
./BSP/RingBuffer/ring_buffer.o 

C_DEPS += \
./BSP/RingBuffer/ring_buffer.d 


# Each subdirectory must supply rules for building sources it contributes
BSP/RingBuffer/%.o BSP/RingBuffer/%.su BSP/RingBuffer/%.cyclo: ../BSP/RingBuffer/%.c BSP/RingBuffer/subdir.mk
...
clean: clean-BSP-2f-RingBuffer

clean-BSP-2f-RingBuffer:
	-$(RM) ./BSP/RingBuffer/ring_buffer.cyclo ./BSP/RingBuffer/ring_buffer.d ./BSP/RingBuffer/ring_buffer.o ./BSP/RingBuffer/ring_buffer.su

.PHONY: clean-BSP-2f-RingBuffer
